...
- d6be63ac: feat(rn): add React Native support for motion presets — Fade, Move, Slide, Scale, Morph, Stagger, and AnimateInteractions (built on the native BaseMotion engine)
- ba4a5941: feat(FilterChip): honour `showClearButton`, add group-level Reset support, and improve multi-select value display
